...
import sudoku.programdomain.Coordinates;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
	...
	private Rectangle getLine(double x, double y, double heigth, double width) {
		Rectangle line = new Rectangle();

		line.setX(x);
		line.setY(y);
		line.setHeight(heigth);
		line.setWidth(width);
	...
	private void drawTitle(Group root) {
		Text tittle = new Text(255, 690, SUDOKU);
